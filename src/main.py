...
def test_send_message():
    ...
    # 测试用例4: 完整时间，预算，游玩景点，具体要求
    print("\n=== 测试4: 完整时间，预算，游玩景点，具体要求的旅行规划 ===")
    message4 ="我的预算是1000，帮我规划一下后天从重庆出发到广州的4天旅行，我想要游玩广州塔"
    response4 = send_message(message4)
    response_text4 = extract_text(response4)
    summary4 = response_text4[:200] + "..." if len(response_text4) > 200 else response_text4
    print(f"回复: {summary4}")
    results.append(f"=== 测试3: 带预算的旅行规划 ===\n请求: {message4}\n回复: {summary4}\n\n完整回复:\n{response_text4}\n\n")
